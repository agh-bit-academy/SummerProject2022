...
SIZE = 15
TEST_NUM = 20
COORDS_TAB = [(randint(L_RANGE, R_RANGE), (randint(L_RANGE, R_RANGE)), (randint(L_RANGE, R_RANGE)))
              for _ in range(SIZE)]
...
R = randint(0, R_RANGE)
STATIC_R_TESTS = [[[(randint(L_RANGE, R_RANGE), (randint(L_RANGE, R_RANGE)), (randint(L_RANGE, R_RANGE)))
                    for _ in range(SIZE)], R]
                  for _ in range(TEST_NUM)]

ALL_RANDOM_TESTS = [[[(randint(L_RANGE, R_RANGE), (randint(L_RANGE, R_RANGE)), (randint(L_RANGE, R_RANGE)))
